...
namespace PalcoNet.PublicacionesUtils
{
    class Publicacion
    {
        ...
        public static Publicacion FromDataRow(DataRow dr)
        {
            ...
            publicacion.estado = dataRow.StringValue("estado");
        ...
        {
            return String.Format("Publicacion({0}, {1}, {2}, {3}, {4})",
                this.id, this.descripcion, this.fechaPublicacion, this.rubro, this.grado);
        }
